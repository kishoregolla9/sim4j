...
\begin{figure}
    \centerline{
      ...
      {\includegraphics[width=2.5in]{results/45DegreeAxis_Random/NetworkConn-vs-Error-Random-6x6-Square-with-50-nodes-1.6-to-3.4radius-50.eps}}\hfil
      \subfigure[Error is lowest as the anchors are near the midpoint between center and corners]
      {\includegraphics[width=2.5in]{results/45DegreeAxis_Random/AnchorSets-vs-Error-Random-6x6-Square-with-50-nodes-1.6-to-3.4radius-50.eps}} }
...
\begin{figure}
    \centerline{
      \subfigure[Error decreasing as network connectivity increases]
      {\includegraphics[width=2.5in]{results/45DegreeAxis_Grid/Connectivity-vs-Error-Grid-7x7-Square-with-49-nodes-1.6-to-3.4Radius.eps}}\hfil
      \subfigure[Error is lowest as the anchors are near the midpoint between center and corners]
      {\includegraphics[width=2.5in]{results/45DegreeAxis_Grid/AnchorSetsVsError-Grid-7x7-Square-with-49-nodes-1.6-to-3.4Radius.eps}} }
