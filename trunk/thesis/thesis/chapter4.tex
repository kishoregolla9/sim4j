...
\begin{figure}
  \centering
    \includegraphics[width=4in]{AnchorNeighborsVsError-Random-10x10-Square-with-100-nodes.eps}
...
\begin{figure}
  \centering
    \includegraphics[width=4in]{NetDiff-R2.5-Rank1-AnchorSet55-.eps}
    \caption{Number of Anchor Neighbors vs Location Error}
...
\begin{figure}
  \centering
    \includegraphics[width=4in]{AnchorTriangleHeightVsError-Random-10x10-Square-with-100-nodes.eps}
...
\begin{figure}
  \centering
    \includegraphics[width=4in]{AnchorTriangleAreaVsError-Random-10x10-Square-with-100-nodes.eps}
