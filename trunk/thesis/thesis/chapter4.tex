...
\subsection{Area of Anchor Triangle}
...
Continuing the trend of trying to show some increased correlation between the anchor coverage and location error, Figure~\ref{fig:AnchorArea} shows the 
