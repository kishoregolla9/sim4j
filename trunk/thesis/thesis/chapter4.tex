...
% 	\subfloat[Mean Distance between Anchors vs Location Error]{\label{fig:AnchorDistancesMean}
% 		\includegraphics[width=0.5\textwidth]{distances/MeanAnchorDistanceVsError.eps}}		
		\\
...
% 	\subfloat[Mean Distance between Anchors vs Location Error Excluding Outliers]{\label{fig:AnchorDistancesMeanExcluding}
% 		\includegraphics[width=0.5\textwidth]{distances/MeanAnchorDistanceVsErrorExcluding.eps}}
