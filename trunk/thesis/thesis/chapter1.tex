...
\begin{figure}
  \centering
    \subfloat[Anchor Set 1]{\includegraphics[width=0.3\textwidth]{motivation/plot1.eps}}
    \subfloat[Anchor Set 2]{\includegraphics[width=0.3\textwidth]{motivation/plot2.eps}}
    \\
    \subfloat[Anchor Set 3]{\includegraphics[width=0.3\textwidth]{motivation/plot3.eps}}
    \subfloat[Anchor Set 4]{\includegraphics[width=0.3\textwidth]{motivation/plot4.eps}}
