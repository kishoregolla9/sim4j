...
\begin{figure}
  \centering
	\subfloat[Sum of distance between anchors vs. mean location error, excluding outliers]{\label{fig:pipessum}
		\includegraphics[width=\figurewidth\textwidth]{pipeline/SumOfDistanceIndicator_pipes}}
	\\
	\subfloat[Minimum height of anchor triangle vs. mean location error]{\label{fig:pipesheight}
		\includegraphics[width=\figurewidth\textwidth]{pipeline/HeightIndicator_pipes}}
	\caption[Anchor metrics for a pipeline topology]{Anchor metrics for 10 random pipeline-shape 20-by-20 unit networks with 200 nodes, 1,000 anchor sets each, and a radio range of 2.0 units}
	\label{fig:pipesindicator}
\end{figure}
