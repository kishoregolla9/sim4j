function [CL, mds_all_results]=mdstestRun(number_of_nets,type,netSize,N,r,step,number_of_levels)
%Li - Oct. 2006, modified Dec 2007
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%function mdstestRun generates a  given number of networks based on the 
% specified type, size and number of nodes. Then it runs  
...
[mds_patchTime,mds_coordinates_median,mds_coordinates_median_average,mds_all_results]=batchMDSLocalization(t,startNode,anchor);
