function [node]=localMapConnectivityOnlyGrid1(Network,epochs,r)
%Computes the node coordinates in the local map of every node in the 'Network'.
...
% It applies the LEM to establish the local edge hop approximation. This
% function applies one level of LEM. If wants to apply two levels of LEM, 
% use localMapConnectivityOnlyGrid.
...
r1=1.35;  %deployment unit radius disk setup
for i=1:N
    for j=1:N
        if D(i,j)<r1
            D_hopCount(i,j)=1;
