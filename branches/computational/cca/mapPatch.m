...
errors(numAnchorSets,numStartNodes) = struct(...
            ...
            'std',0,...
            'time',0);
anchorErrors(numAnchorSets) = struct(...
            'mean',0,...
            'median',0,...
            'max',0,...
            'min',0,...
...
function [result,errors,anchorErrors] = calculateErrors(network, radius,localMaps,...
    ...
    anchorErrors = struct(...
        'mean',sum(mean(differenceVector(anchorNodes,:))),...
        'median',sum(median(differenceVector(anchorNodes,:))),...
        'max',sum(max(differenceVector(anchorNodes,:))),...
        'min',sum(min(differenceVector(anchorNodes,:))),...
        'std',sum(std(differenceVector(anchorNodes,:))));
end
