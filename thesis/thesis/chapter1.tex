...
\begin{figure}
  \centering
    \subfloat[Anchor Set 1]{\includegraphics[width=0.5\textwidth]{motivation/plot1}}
    \subfloat[Anchor Set 2]{\includegraphics[width=0.5\textwidth]{motivation/plot2}}
    \\
    \subfloat[Anchor Set 3]{\includegraphics[width=0.5\textwidth]{motivation/plot3}}
    \subfloat[Anchor Set 4]{\includegraphics[width=0.5\textwidth]{motivation/plot4}}
