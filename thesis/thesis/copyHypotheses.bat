...
copy %1\eps\AnchorSetErrors-Random-20x20-Square-with-400-nodes-Radius2.5-to-2.5.eps ..\thesis\figures\numneighbors\AnchorSetErrorVsError.eps
copy %1\eps\AnchorSetErrors-Random-20x20-Square-with-400-nodes-Radius2.5-to-2.5-Excluding2.0.eps ..\thesis\figures\numneighbors\AnchorSetErrorVsErrorExcluding.eps
